...
def build_loaders(
    ...
    *,
    ...
    # Shaped label exclusion now handled inside GlyphRasterDataset BEFORE pre-rasterization
...
def main(argv=None) -> int:
    ...
    model = None
    optimizer = None
    # Removed outer try: using explicit cleanup at end instead of try/except-finally
    ...
    # Explicit cleanup (normal exit path)
    if cleanup_cuda:
